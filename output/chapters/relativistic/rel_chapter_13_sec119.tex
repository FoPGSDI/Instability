...
(\partial p/\partial\varepsilon)_{s}\,\delta\varepsilon$ (since $\cs^{2} = (\partial
p/\partial\varepsilon)_{s} \leq c^{2}$; see
\texttt{RELATIVISTIC\_CONVENTIONS.md}), this becomes
\begin{equation}
