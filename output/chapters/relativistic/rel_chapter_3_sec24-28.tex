...
a BDNK causal first-order heat equation rather than the parabolic Fourier law:
...
The BDNK causal modifications time $\tauq$ ensures that the heat mode
...
In the BDNK framework the shear stress obeys
...
$\sigma$ with finite-order terms only (the BDNK causal modifications
...
\begin{enumerate}
  ...
  \item All modes are causal when BDNK causal modifications times
