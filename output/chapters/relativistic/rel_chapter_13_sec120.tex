...
\noindent
For the Israel--Stewart causal dissipation framework ensuring finite
propagation speeds in relativistic fluids, see:

\begin{enumerate}
\setcounter{enumi}{14}
\item W.~Israel and J.~M.~Stewart, `Transient relativistic
