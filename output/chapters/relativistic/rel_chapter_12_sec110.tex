...
\paragraph{Quantitative estimate: M87 jet knots.}
For the M87 jet, with $R_{\mathrm{jet}}\sim 100\;\mathrm{pc}$,
$\varepsilon\sim 10^{-9}\;\mathrm{erg/cm^{3}}$, and
$H_{z}\sim 10\;\mu\mathrm{G}$, the critical field
$H_{0,\mathrm{rel}} \approx 4\pi R\,c\,\sqrt{G\rho_{G}^{2}/w_{\mathrm{tot}}}
\sim 5\;\mu\mathrm{G}$, giving $H/H_{0,\mathrm{rel}}\sim 2$.
The minimum unstable wavelength is then
$\lambda_{\min}\sim 2\pi R/x_{a} \sim 10\,R_{\mathrm{jet}}\sim 1\;\mathrm{kpc}$,
consistent with the observed knot spacing of $\sim 1$--$3\;\mathrm{kpc}$
in the M87 jet.  Figure~\ref{fig:magnetized-jet-knots} displays the
full dependence of the fragmentation scale and growth rate on the field
strength ratio.

\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{plots/ch12/fig_magnetized_jet_knots.pdf}
\caption{%
