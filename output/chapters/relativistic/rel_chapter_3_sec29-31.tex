...
\subsection{BDNK perturbation equations with rotation}

Recall that in the BDNK framework the linearised heat-flux
...
becomes \emph{quintic} in the BDNK formalism.
...
For $p = 0.025$ (mercury) and the BDNK causal modifications
