...
\item[(ii)] The BDNK first-order viscous constitutive relation introduces
  frame coefficients for the viscous stress tensor.
  In the linearised perturbation equations, this manifests as a
  modification of the diffusion operator in the viscous terms.
\end{enumerate}
...
\item The \emph{BDNK causal framework} modifies the viscous
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.75\textwidth]{fig_disk_stability_map.pdf}
...
causal.  The BDNK causal framework ensures finite viscous
