...
\item[(iv)] Heat propagation must be treated within a causal dissipative
  ...
  first-order theory~\cite{Bemfica2018,Kovtun2019,Bemfica2019}, in which
...
equation~\cite{Bemfica2018,Kovtun2019}.  In the BDNK framework, the
...
\end{equation}
where $\kappa_{\mathrm{rel}}$ is the thermal diffusivity.  Causality
...
modes~\cite{Bemfica2018,Kovtun2019}.  Crucially, at the marginal state
...
conditions on the transport coefficients~\cite{Bemfica2018,Kovtun2019,
HoultKovtun2020}.
...
hyperbolicity~\cite{Bemfica2018,Kovtun2019,BemficaEtAl2023}.
Specifically:
\begin{enumerate}
...
\item The Fourier heat equation is replaced by the BDNK first-order
  causal constitutive relation~\cite{Bemfica2018,Kovtun2019}.
