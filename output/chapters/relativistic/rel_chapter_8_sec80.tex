...
with the BDNK first-order constitutive relation~\eqref{eq:rel-8-203}
...
Fultz~(\S\,\ref{sec:79d}), the BDNK causality time for
water at room temperature, the BDNK frame corrections are negligible, giving
entirely negligible relativistic
