...
physical picture \cite{NSradialBDNK2025}.
...
\begin{enumerate}
  ...
  \item The IS prediction places several LMXBs \emph{inside} the
    ...
    modified Urca viscosity suffices \cite{BDNKNSevolution2025}.
\end{enumerate}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{plots/deep/fig_rmode_window.pdf}
...
neutron stars \cite{Lasky2015,Abbott2017GW170817}.
