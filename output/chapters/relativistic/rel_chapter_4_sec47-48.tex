...
\citep{BemficaDN2018,Kovtun2019}.  For the marginal state
...
and frame coefficients \citep{BemficaDN2018,Kovtun2019}.
\end{causalitycheck}
...
\cite{Strohmayer2005,DR11_BDNKtwoSphere2025}.  We now analyse these modes
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{fig_magnetar_qpo.pdf}
...
\begin{itemize}
  ...
  \item The low-frequency cluster (18--30~Hz) requires either
    ...
    in the liquid core \cite{DR11_BDNKtwoSphere2025}.
